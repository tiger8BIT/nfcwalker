...
object TestAuth {
     ...
     */
    fun generateCustomToken(subject: String = UUID.randomUUID().toString(), roles: List<String>): String {
        val now = Date()
    ...
    fun generateBossToken(subject: String = UUID.randomUUID().toString()) = generateCustomToken(subject, listOf("ROLE_BOSS"))
    fun generateWorkerToken(subject: String = UUID.randomUUID().toString()) = generateCustomToken(subject, listOf("ROLE_WORKER"))
    fun generateAppOwnerToken(subject: String = UUID.randomUUID().toString()) = generateCustomToken(subject, listOf("ROLE_APP_OWNER"))
